...
public class GameMenu : MonoBehaviour {
    ...
    void Start()
    {
        ...
        for (int i = 0; i < scripts.Length; i++)
        {
            ...
            string s = scripts[i];
            player0Dropdown.scriptselect.options.Add(new UnityEngine.UI.Dropdown.OptionData(s.Substring(s.LastIndexOf("/") + 1).Replace(".txt", "")));
            player1Dropdown.scriptselect.options.Add(new UnityEngine.UI.Dropdown.OptionData(s.Substring(s.LastIndexOf("/") + 1).Replace(".txt", "")));
        }
